...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    // Find the product by ID from the monitorProducts array
    const foundProduct = monitorProducts.find(p => p.id.toString() === productId)
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex justify-between p-2 border-b">
                ...
                <span>{product.category === "monitor" ? product.title.split(" ")[0] : "Generic"}</span>
              </div>
              <div className="flex justify-between p-2 border-b">

...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    // Find the product by ID from the videoCardProducts array
    const foundProduct = videoCardProducts.find(p => p.id.toString() === productId)
    ...
    <>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex text-sm text-gray-500 mb-6">
          ...
          <Link href="/category/video-card" className="hover:underline">Video Cards</Link>
          <span className="mx-2">&gt;</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6">{product.description || "A high-quality PC Video Cards designed for optimal airflow and component compatibility."}</p>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex justify-between p-2 border-b">
                ...
                <span>{product.category === "video-card" ? product.title.split(" ")[0] : "Generic"}</span>
              </div>
              <div className="flex justify-between p-2 border-b">

...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    ...
    const foundProduct = memoryProducts.find(p => p.id.toString() === productId)
    ...
    <>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex text-sm text-gray-500 mb-6">
          ...
          <Link href="/category/memory" className="hover:underline">Memory</Link>
          <span className="mx-2">&gt;</span>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex justify-between p-2 border-b">
                ...
                <span>{product.category === "memory" ? product.title.split(" ")[0] : "Generic"}</span>
              </div>
              <div className="flex justify-between p-2 border-b">
